...
const MyAccountNavigationView = ({ onSectionChange, activeSection }) => {
          ...
          <tr className="w-full">
            <th className="w-[auto]">
              <button
                className={`text-blue-950 py-[18px] px-6  font-medium  transition-all ease-in-out ${
                  activeSection === "basic-informations-view"
                    ? "border-b border-primary text-primary"
                    : ""
                }`}
                onClick={() => handleClick("basic-informations-view")}
              >
                {" "}
                Basic Information
              </button>
            ...
            <th className="w-[117px]">
              <button
                ...
                onClick={() => handleClick("address-view")}
              >
                Address
              </button>
            </th>
            <th className="w-[155px]">
              <button
                ...
                onClick={() => handleClick("seller-detail-view")}
              >
                Seller Details
              </button>
            </th>
            <th className="w-[215px]">
              <button
                ...
                onClick={() => handleClick("payment-information-view")}
              >
                Payment Information
              </button>
            </th>
...
export default MyAccountNavigationView;
