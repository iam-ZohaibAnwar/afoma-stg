...
const SellerSidebar = ({ }) => {
  ...
  return (
    <>
      <div
        ref={sidebar}
        className={`bg-orange-100 shrink-0 h-full mx-auto p-6 2xl:pl-20 2xl:pr-12 flex flex-col gap-20 justify-between overflow-y-scroll scrollbar absolute lg:shadow-none shadow-lg left-0 top-0 z-[9999] duration-300 ease-linear lg:static lg:translate-x-0 ${
            ...
            <ul className="text-slate-400 text-sm ">
              ...
              >
                <div className="flex gap-3 items-center">
                  ...
                  <Link href="/seller/dashboard" legacyBehavior>
                    <p>
              ...
              <li
                className={`relative text-blue-950 mb-2 hover:text-primary hover:bg-orange-50 p-3.5 rounded flex items-center gap-4 cursor-pointer xl:w-[300px] 2xl:w-[335px] ${
                  path.includes("/seller/my-orders")
                    ? "text-primary bg-orange-50"
                    : ""
                }`}
              >
                <div className="flex gap-3 items-center">
                  ...
                  <Link href="/seller/my-orders" legacyBehavior>
                    <p>
                      <span className=" w-full h-full xl:text-lg">
                        My Orders
                      </span>
              ...
              <li
                className={`relative text-blue-950 mb-2 hover:text-primary hover:bg-orange-50 p-3.5 rounded flex items-center gap-4 cursor-pointer xl:w-[300px] 2xl:w-[335px] ${
                  path.includes("/seller/my-account")
                    ? "text-primary bg-orange-50"
                    : ""
                }`}
              >
                <div className="flex gap-3 items-center">
                  ...
                  <Link
                    href="/seller/my-account/basic-information/view"
                    legacyBehavior
                  >
                    <p>
                      <span className=" w-full h-full xl:text-lg">
              ...
              <li
                className={`relative text-blue-950 mb-2 hover:text-primary hover:bg-orange-50 p-3.5 rounded flex items-center gap-4 cursor-pointer xl:w-[300px] 2xl:w-[335px] ${
                  path.includes("/seller/order-management")
                    ? "text-primary bg-orange-50"
                    : ""
                }`}
              >
                <div className="flex gap-3 items-center">
                  ...
                  <Link href="/seller/order-management" legacyBehavior>
                    <p>
                      <span className=" w-full h-full xl:text-lg">
                        Order Management
                      </span>
              ...
              >
                <div className="flex gap-3 items-center">
                  <div className="w-7">
                    <FontAwesomeIcon icon={faBoxTaped} className="text-xl" />
                  </div>

                  <Link href="/seller/product" legacyBehavior>
                    <p>
                      <span className=" w-full h-full xl:text-lg">
                        Product Management
                      </span>
              ...
              <li
                className={`relative text-blue-950 mb-2 hover:text-primary hover:bg-orange-50 p-3.5 rounded flex items-center gap-4 cursor-pointer xl:w-[300px] 2xl:w-[335px] ${
                  path.includes("/seller/custom-attribute-management")
                    ? "text-primary bg-orange-50"
                    : ""
                }`}
              >
                <div className="flex gap-3 items-center">
                  ...
                  <Link
                    href="/seller/custom-attribute-management"
                    legacyBehavior
                  >
                    <p>
                      <span className=" w-full h-full xl:text-lg">
              ...
              >
                <div className="flex gap-3 items-center">
                  ...
                  <Link href="/seller/earning" legacyBehavior>
                    <p>
                      <span className=" w-full h-full xl:text-lg">
                        Earnings
                      </span>
              ...
              <li
                className={`relative text-blue-950 mb-2 hover:text-primary hover:bg-orange-50 p-3.5 rounded flex items-center gap-4 cursor-pointer xl:w-[300px] 2xl:w-[335px] ${
                  path.includes("/seller/my-wallet")
                    ? "text-primary bg-orange-50"
                    : ""
                }`}
              >
                <div className="flex gap-3 items-center">
                  ...
                  <Link href="/seller/my-wallet" legacyBehavior>
                    <p>
                      <span className=" w-full h-full xl:text-lg">
                        My Rewards
                      </span>
              ...
              >
                <div className="flex gap-3 items-center">
                  ...
                  <Link href="/seller/review" legacyBehavior>
                    <p>
              ...
              >
                <div className="flex gap-3 items-center">
                  ...
                  <Link href="/seller/support" legacyBehavior>
                    <p>
                      <span className=" w-full h-full xl:text-lg">Support</span>
                      <span className="absolute top-0 left-0 h-full w-full"></span>
                    </p>
                  </Link>
                </div>
              ...
              >
                <div className="flex gap-3 items-center">
                  ...
                  <Link href="/seller/coupons" legacyBehavior>
                    <p>
              ...
              <li
                className={`relative text-blue-950 mb-2 hover:text-primary hover:bg-orange-50 p-3.5 rounded flex items-center gap-4 cursor-pointer xl:w-[300px] 2xl:w-[335px] ${
                  path.includes("/seller/shipping-config")
                    ? "text-primary bg-orange-50"
                    : ""
                }`}
              >
                <div className="flex gap-3 items-center">
                  ...
                  <Link href="/seller/shipping-config" legacyBehavior>
                    <p>
                      <span className=" w-full h-full xl:text-lg">
                        Shipping Config
                      </span>
              ...
              >
                <div className="flex gap-3 items-center">
                  ...
                  <Link href="/seller/settings" legacyBehavior>
                    <p>
                      <span className=" w-full h-full xl:text-lg">
                        Settings
                      </span>
