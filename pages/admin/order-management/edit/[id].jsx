...
import { faCircleInfo, faImage, fal } from "@fortawesome/pro-light-svg-icons";
...
const AdminOrderManagementView = (id) => {
  ...
  const [selectedMenuItem1, setSelectedMenuItem1] = useState("Pending");
  const [selectedMenuItem2, setSelectedMenuItem2] = useState("Pending");
  const [selectedMenuItem3, setSelectedMenuItem3] = useState("Pending");
  ...
  const handleMenuItemClick1 = (menuItem, setData) => {
    setSelectedMenuItem1(menuItem);
    // Update data.status based on the selected menu item
    if (menuItem === "Completed") {
      setData({ ...data, status: "Completed" });
    } else if (menuItem === "Shipped") {
      setData({ ...data, status: "Shipped" });
    } else if (menuItem === "Cancel order") {
      setData({ ...data, status: "Cancel order" });
    }
  };
    ...
    <>
      ...
      <Layout userType="admin">
                        ...
                        <div className="py-2">
                          <Menu.Item>
                            <button
                              ...
                              onClick={() => handleMenuItemClick1("Completed")}
                            >
                              Completed
                            </button>
                          </Menu.Item>
                          <Menu.Item>
                            <button
                              ...
                              onClick={() => handleMenuItemClick1("Shipped")}
                            >
                              Shipped
                            </button>
                          </Menu.Item>
                ...
                <table className="text-sm w-full table-fixed border-separate border-spacing-0 bg-orange-50 ">
                  <thead className="text-left text-sm font-medium text-orange-50 bg-blue-950 h-14">
                    <tr>
                      ...
                      <th className=" px-5 w-[270px]">Personalized Note</th>
                      <th className=" px-5  font-medium w-[200px]">
                        Download Product
                      </th>
                      <th className=" px-5 w-[200px]">Payment Status</th>
                      <th className=" px-5 w-[200px]">Delivery Status</th>
                      {order?.cart?.length > 0 &&
                                  ...
                                  <div className="py-2">
                                    ...
                                    <Menu.Item>
                                      <button
                                        ...
                                        onClick={() =>
                                          handleMenuItemClick1("Cancelled")
                                        }
                                      >
                                        Cancelled
                                      </button>
       ...
       <div className="flex gap-2 mt-3">
              ...
              <div className="p-5 md:w-[392px] bg-orange-100 border  rounded">
              ...
              <div className="mt-8">
                ...
                >
                  <Form>
                    ...
                    <div className="grid md:gap-6 gap-4 md:grid-cols-3 grid-cols-2 mb-6">
                      <div className="relative">
                        <div>
                          {" "}
                          <label
                        ...
                        <div className="mt-3">
                          <Field
                            ...
                            placeholder={order.userInfo?.firstName ? `${order.userInfo?.firstName} ${order.userInfo?.lastName}`: `${order.userInfo?.name}`}
                            className="bg-orange-100 border border-[#47556980] w-full text-sm font-medium text-slate-600 p-3.5 rounded pointer-events-none"
                          />
                        </div>
                      </div>
                    ...
                    <div className="relative mt-8">
                      ...
                      <div className="grid md:gap-6 gap-4 md:grid-cols-3 mb-6"></div>
                    </div>
                  </Form>
                </Formik>
              </div>
