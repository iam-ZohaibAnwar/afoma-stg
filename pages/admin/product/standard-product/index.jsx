    ...
    if (editData?._id) {
      ...
      axios
        ...
        .then(function (response) {
          ...
          router.push(
            `/admin/product/standard-product?id=${response.data.newProduct._id}&scroll=save`
          );
        })
        .catch(function (error) {
          console.error(error);
              ...
              >
                {({
                  ...
                  <Form className="st-form">
                      ...
                      >
                        ...
                        <div
                          className={`ml-2 h-[20px] w-[20px] ${
                            values.productName && values.productName.length > 10
                        ...
                        <div className="relative">
                          ...
                          <Field
                            ...
                            onChange={async (e) => {
                              ...
                              const price = await handlePriceChange(
                                e.target.value
                              );
                    ...
                    <div className="col-span-3">
                      <h3
                        className={`text-lg md:text-2xl xl:tracking-[-0.48px] my-5 noto-font`}
                      >
                    ...
                    <div className="relative viewOnly col-span-2 my-4">
                    ...
                    <div className="flex gap-1.5 items-center md:mt-0 mt-2">
                      <h3
                    ...
                    <div className="flex gap-4 items-center col-span-3 relative mt-8" id="save-button-wrapper">
                      <button
                        type="submit"
