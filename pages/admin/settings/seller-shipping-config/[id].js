...
const Index = () => {
    const [initialValues, setInitialValues] = useState({
        domestic: { flat_rate: false, afoma_shipping: false, hand_delivery: false, hand_delivery_options: { free_delivery: false, fee_rate: null }, flat_rate_options: { free_shipping: false, is_flat_rate: false, flat_rate_rate: null, additional_cost: null, is_flat_weighted: false, flat_rate_0_1: null, flat_rate_1_5: null, flat_rate_5_A: null } },
        international: { flat_rate: false, afoma_shipping: false, hand_delivery: false, hand_delivery_options: { free_delivery: false, fee_rate: null }, flat_rate_options: { free_shipping: false, is_flat_rate: false, flat_rate_rate: null, additional_cost: null, is_flat_weighted: false, flat_rate_0_1: null, flat_rate_1_5: null, flat_rate_5_A: null } },
    });
    ...
    const [isFreeDeliveryInternational, setIsFreeDeliveryInternational] = useState(false);

    const [showModalFlatRateDomestic, setShowModalFlatRateDomestic] = useState(false);
    ...
    const [faltRateInternationalEnable, setFaltRateInternationalEnable] = useState(false);
    ...
    const [flatWeightedRateDomesticEnable, setFlatWeightedRateDomesticEnable] = useState(false);
    const [flatWeightedRateInternationalEnable, setFlatWeightedRateInternationalEnable] = useState(false);
    ...
    const fetchShippingConfig = async (id) => {
        setLoading(true);
        const options = {
          method: "GET",
          url: `${process.env.NEXT_PUBLIC_BASE_URL}/seller/shipping-config/${id}`,
        };
