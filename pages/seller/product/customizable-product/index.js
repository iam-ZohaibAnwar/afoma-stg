...
const Index = ({ keywords, prePopulatedData }) => {
  ...
  useEffect(() => {
    ...
    // If user data exists, create headers object with authorization token
  ...
  const handleSubmit = (values, { setSubmitting, resetForm }) => {
    ...
    if (editData?._id) {
      ...
      axios
        ...
        .then(function (response) {
          router.push(
            `/seller/product/customizable-product/product-variations?id=${response?.data?.updatedProduct?._id}`
          );
          setSubmitting(false);
      ...
      setSubmitting(true);
      let seller = persons.find((person) => person._id == values.seller);
      ...
      axios
        ...
        .then(function (response) {
          router.push(
            `/seller/product/customizable-product/product-variations?id=${response.data.newProduct._id}`
          );
          setSubmitting(false);
...
"
      ...
      <Layout userType="seller">
        <>
          <section>
            <div className="pb-36 max-w-screen-2xl mx-auto">
                                  ...
                                  <Select
                                    ...
                                    onChange={(selectedOption) => {
                                      ...
                                      const hasChildCategories =
                                        ...
                                        selectedOption.childCategories.length >
                                          0;

                                      setChildCategoryDisabled(
                                        !hasChildCategories
                                      );
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-5 w-full mt-4">
                          <div className="relative col-span-1 md:col-span-2 lg:col-span-3">
                            <div>
                              ...
                              <p className=" mb-2 text-blue-950/80 font-medium -mt-1 text-sm">
                                The duration for making your craft and dropping
                                off with shipping company
                              </p>
                            </div>
                            <Field
                              type="text"
                          ...
                          <div className="relative md:col-span-2 lg:col-span-3 viewOnly">
